...
async function generateLeaveFormPDF(leave, employees) {
  ...
  fieldBox(margin + cw/2 + 1, y, cw/2 - 1, 13, "Staff Number", emp.staff_no || "");
  y += 14;
  fieldBox(margin, y, cw/2 - 1, 13, "Department / Location", emp.location || "");
  ...
  fieldBox(margin, y, cw/2 - 1, 13, "Address While Away", "");
  ...
  doc.setFontSize(7.5);
  doc.setFont("helvetica", "normal");
  doc.text("He/She    ☐ Deserves    ☐ Does not deserve    to proceed on leave", margin + 3, y + 5.8);
  y += 10;
  fieldBox(margin, y, cw/3 - 1, 13, "From", "");
  fieldBox(margin + cw/3 + 1, y, cw/3 - 1, 13, "To", "");
  fieldBox(margin + 2*cw/3 + 1, y, cw/3 - 1, 13, "Signature & Date", "");
  y += 17;

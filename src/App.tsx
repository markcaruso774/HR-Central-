...
function Dashboard({ employees, leaveRequests, attendance, user }) {
  ...
  const malePresent = presentEmps.filter(e => e.gender?.toLowerCase() === "male").length;
  const femalePresent = presentEmps.filter(e => e.gender?.toLowerCase() === "female").length;
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 14, marginBottom: 24 }}>
        ...
        <Card style={{ padding: 20 }}>
          ...
          <div style={{ marginTop: 4 }}>
            ...
            <div style={{ height: 6, borderRadius: 4, background: C.border, overflow: "hidden" }}>
              <div style={{ height: "100%", width: `${malePresentPct}%`, background: "linear-gradient(90deg, #3b82f6, #f472b6)", borderRadius: 4 }} />
            </div>
          </div>
        </Card>

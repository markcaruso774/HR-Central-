...
function Attendance({ employees, isHR, setSelectedEmployee }) {
  ...
  const loadTesseract = () => new Promise((res, rej) => {
    ...
    const tryLoad = (src) => new Promise((r, e) => {
      const s = document.createElement("script");
      s.src = src;
    ...
    tryLoad("https://unpkg.com/tesseract.js@4.1.1/dist/tesseract.min.js")
      .then(res)
      .catch(() => tryLoad("https://cdn.jsdelivr.net/npm/tesseract.js@4.1.1/dist/tesseract.min.js")
      .then(res).catch(rej));
  });
  ...
  const processOCR = async () => {
    ...
    try {
      await loadTesseract();
      if (!window.Tesseract) throw new Error("Tesseract library failed to load. Check your internet connection.");
      ...
      for (const page of ocrPages) {
        ...
        allRows = [...allRows, ...parseOCRText(text)];
      }

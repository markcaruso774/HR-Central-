  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ background: C.accent + "15", border: `1px solid ${C.accent}33`, borderRadius: 10, padding: "10px 16px", display: "flex", alignItems: "flex-start", gap: 10 }}>
          <span style={{ fontSize: 16 }}>💡</span>
          <p style={{ color: C.accent, fontSize: 12, margin: 0, fontStyle: "italic", lineHeight: 1.6 }}>{todayQuote}</p>
        </div>
      </div>
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ background: C.accent + "15", border: `1px solid ${C.accent}33`, borderRadius: 10, padding: "10px 16px", display: "flex", alignItems: "flex-start", gap: 10 }}>
          <span style={{ fontSize: 16 }}>💡</span>
          <p style={{ color: C.accent, fontSize: 12, margin: 0, fontStyle: "italic", lineHeight: 1.6 }}>{hrQuote}</p>
        </div>
      </div>

...
function Attendance({ employees, isHR, setSelectedEmployee }) {
  ...
  const processOCR = async () => {
    ...
    try {
      ...
      for (const page of ocrPages) {
        const { data: { text } } = await worker.recognize(page.file);
  ...
  const unmarked = total - records.filter(r => filteredEmployees.some(e => e.id === r.employee_id)).length;
              ...
              {ocrStep === 1 && (
                <div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <input ref={ocrRef1} type="file" accept="image/*" capture="environment" onChange={e => addPage(e, 1)} style={{ display: "none" }} />
                  </div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <input ref={ocrRef2} type="file" accept="image/*" capture="environment" onChange={e => addPage(e, 2)} style={{ display: "none" }} />
                  </div>
